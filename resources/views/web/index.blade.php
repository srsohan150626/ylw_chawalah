...
<html>
    ...
    <head>
        ...
        <link href="{{asset('web/css/theme/jqm/jqm.css')}}" rel="stylesheet" />
        <link href="{{asset('web/css/theme/flat-ui/flat-ui.css')}}" rel="stylesheet" />
        <link href="{{asset('web/libs/apperyio/iphone-fix.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('web/libs/jquerymobile/1.4.5/jquery.mobile.structure-1.4.5.css')}}" rel="stylesheet"
        />
        <link type="text/css" rel="stylesheet" href="{{asset('web/css/swiper4.3.3.css')}}" />
        <link type="text/css" rel="stylesheet" href="{{asset('web/css/SwiperCSS.css')}}" />
        ...
        <link href="{{asset('web/Dubai.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{asset('web/libs/apperyio/mobilebase.css')}}" rel="stylesheet" type="text/css" />
