...
data-theme="f">
    ...
    dsid="mobilecontainer" data-theme="f">
        ...
        <!-- mobileimage_500 -->
        <img class="bottomrightbutton " src="{{asset('web/img/ICONS-01B.png')}}"
        id="" dsid="mobileimage_500" name="" />
        <!-- mobileimage_499 -->
        <img class="bottomleftbutton " src="{{asset('web/img/ICONS-04B.png')}}"
        id="" dsid="mobileimage_499" name="" />
        <!-- html_3 -->
                    ...
                    <tr class="Dubai_mobilegrid_73_row_0">
                        ...
                        colspan=1 rowspan=1>
                            <div class="cell-wrapper">
                                ...
                                <img class="Dubai_mobileimage_79" src="{{asset('web/img/chala.png')}}" id="Dubai_mobileimage_79')}}"
                                dsid="mobileimage_79" name="mobileimage_79" />
                            </div>
                        </td>
                        <!-- mobilegridcell_78 -->
                ...
                <tr class="Dubai_mobilegrid_506_row_0">
                    ...
                    colspan=1 rowspan=1>
                        <div class="cell-wrapper">
                            ...
                            x-apple-data-detectors="false" data-mini="true" data-theme="f" tabindex="15" onclick="window.history.go(-1); return false;" type="submit" value="Cancel">
                            BACK
                            </a>
                        </div>
                    </td>
