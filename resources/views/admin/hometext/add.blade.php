...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>HomeText <small>Add HomeText...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">Add HomeText</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Add HomeText </h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/hometexts/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-10 col-md-8">
                                                                            <textarea id="editor" name="upper_text" class="form-control" rows="5"></textarea>
                                                            ...
                                                            <div style="margin-top: 15px;" class="tab-pane active" id="product_1">
                                                                <div class="">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-10 col-md-8">
                                                                            <textarea id="editorlower" name="lower_text" class="form-control" rows="5"></textarea>
                                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
