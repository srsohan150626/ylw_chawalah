                                        ...
                                        @if( count($errors) > 0)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($settings[87]->value,  $settings[87]->value, array('class'=>'form-control number-validate', 'id'=>$settings[87]->value, 'name'=>'ThumbnailHeight')) !!}
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($settings[88]->value,  $settings[88]->value, array('class'=>'form-control number-validate', 'id'=>$settings[88]->value, 'name'=>'ThumbnailWidth')) !!}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($settings[89]->value,  $settings[89]->value, array('class'=>'form-control number-validate', 'id'=>$settings[89]->value, 'name'=>'MediumHeight')) !!}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($settings[90]->value,  $settings[90]->value, array('class'=>'form-control number-validate', 'id'=>$settings[90]->value, 'name'=>'MediumWidth')) !!}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($settings[91]->value,  $settings[91]->value, array('class'=>'form-control number-validate', 'id'=>$settings[91]->value, 'name'=>'LargeHeight')) !!}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($settings[92]->value,  $settings[92]->value, array('class'=>'form-control number-validate', 'id'=>$settings[92]->value, 'name'=>'LargeWidth')) !!}
