                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                                <div class="col-xs-12 col-md-6">
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-3 control-label">Barcode<span style="color:red;">*</span></label>
                                                        <div class="col-sm-10 col-md-8">
                                                            {!! Form::text('barcode', $result['product'][0]->barcode, array('class'=>'form-control field-validate number-validate', 'id'=>'barcode')) !!}
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                Please Enter your product Barcode
                                                            </span>
                                                            <span class="help-block hidden">Please Enter your product Barcode</span>
                                                        </div>
                                                    </div>
                                                </div>
