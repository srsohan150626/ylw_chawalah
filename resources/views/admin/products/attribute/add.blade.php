                                            ...
                                            @foreach($result['products_attributes'] as $key=>$products_attributes)
                                                @if($products_attributes->is_default == '1')
                                                    <tr>
                                                        ...
                                                        <td>{{ $products_attributes->barcode }}</td>
                                                    <!--<td>{{ $products_attributes->price_prefix }}{{ $products_attributes->options_values_price }}</td>-->
                                                        <td>
                                                            <a class="badge bg-light-blue editdefaultattributemodal" products_id = '{{ $products_attributes->products_id }}' products_attributes_id = "{{ $products_attributes->products_attributes_id }}"  options_id = '{{ $products_attributes->options_id }}'
                                                            barcode = '{{ $products_attributes->barcode }}'
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-4 control-label">Barcode</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <input  type="text" class="form-control barcode field-validate" name="barcode">
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                        Give Barcode of this Attribute</span>
                                                        </div>
                                                    </div>
                                            ...
                                            @foreach($result['products_attributes'] as $key=>$products_attributes)
                                                ...
                                                @if($products_attributes->is_default == '0')
                                                    <tr>
                                                        ...
                                                        <td>{{ $products_attributes->barcode }}</td>
                                                        <td>
                                                            <a class="badge bg-light-blue editproductattributemodal" products_id = '{{ $products_attributes->products_id }}' products_attributes_id = "{{ $products_attributes->products_attributes_id }}" options_id = '{{ $products_attributes->options_id }}' 
                                                            barcode = '{{ $products_attributes->barcode }}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
