                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-4 control-label">Product Attribute  </label>
                                            <div class="col-sm-2 col-md-4">
                                                <select class="form-control  additional-option-id field-validate" name="products_options_id">										<option value="" class="field-validate">Choose Colour</option>
                                                    @foreach($result['products_attributes'] as $option)
                                                        <option value="{{ $option->products_attributes_id }}">{{ $option->options_values_name }}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
