                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8">
                                                                            <select class="form-control select2 select2-hidden-accessible field-validate product-type" style="width: 100%;" tabindex="-1" aria-hidden="true" name="products_id">
                                                                ...
                                                                {{-- <div class="form-group">
                                                                    <label for="name" class="col-sm-2 col-md-4 control-label">Purchase Price<span style="color:red;">*</span></label>
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <input type="text" name="purchase_price" value="" class="form-control stock-validate">
                                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;" required>
                                                                            Enter Purchase Price</span>
                                                                    </div>
                                                                </div> --}}
