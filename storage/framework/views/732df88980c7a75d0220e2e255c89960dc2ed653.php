...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Extras <small>Add Extra Options...</small> </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Add Extra Options </h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php echo Form::open(array('url' =>'admin/menuitems/extras/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>


                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Name')); ?><span style="color:red;">*</span> (English)</label>
                                            <div class="col-sm-10 col-md-4">
                                                <input name="optionName" class="form-control field-validate">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sohan_project\chawalah\resources\views/admin/extraoptions/add.blade.php ENDPATH**/ ?>