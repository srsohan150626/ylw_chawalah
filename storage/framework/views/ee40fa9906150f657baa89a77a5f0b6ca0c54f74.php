...
$(document).on('click', '#addDefaultAttribute', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("admin/menuitems/attach/addons/add")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
...
<?php /**PATH D:\sohan_project\backup\New folder\chawalah\resources\views/admin/common/scripts.blade.php ENDPATH**/ ?>